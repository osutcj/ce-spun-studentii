...
import { QUESTIONS_COLLECTION } from '../contants';
import { firestore } from '../firebase/firebase';
import { DBAnswer } from '../../shared/types/questions';
...
const answers = [
  ...
  [
    ...
    'Inveti-31',
    'Pui un pomelnic-23',
    'Trimiti pe altcineva-6',
    'Te milogești de prof-4',
    'Mita-3',
    '',
    '',
    '',
  ...
  [
    'Nu te duci-36',
    'Cafea-20',
    'Razi cu prietenii-15',
    'Te joci pe telefon-13',
    'Energizant-7',
    'Somn de dinainte-5',
    'Iti faci notite-4',
    '',
  ...
  [
    ...
    'Cas pane-15',
    'Prajitura-13',
    'Snitel Elvetian/Gordon Bleu-12',
    'Gratar de porc-7',
    'Friptura de pui-5',
    '',
    '',
  ...
  [
    'Rezistenta materialelor-34',
    'Mecanica - Furdulea-17',
    'Electronica de putere - Festila-16',
    'ASDN - Cret-15',
    'MP - Cistelecan-15',
    'TM - Varga-3',
    '',
  ...
  [
    'Pizza snack-39',
    'Foietaj cu carnacior-21',
    'Foietaj cu ciocolata-14',
    'Gogosi-12',
    'Foietaj cu Telemea-9',
    'Melc cu stafide-5',
    '',
    '',
    '',
  ...
  [
    ...
    'Ii sarac-17',
    'Prieteni-8',
    'Colegi de camera enervanti-7',
    'Obligat de parinti-5',
    '',
    '',
    '',
    '',
